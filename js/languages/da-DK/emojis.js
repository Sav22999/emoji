...
emojis_language[lang][2] = {
    ...
    '🫢': [
        'Ansigt med Open Eyes og Hand Over Mouth',
    ...
    '🫤': [
        'Ansigt med Diagonal Mouth',
        ':face_with_diagonal_mouth:'
    ],
    '🥹': [
        'Ansigt Holding Tilbage Tører',
...
emojis_language[lang][3] = {
    ...
    '👷{{skin_tone}}‍♂️': [
        'Mand Construction Worker',
        ':man_contruction_worker:',
        ':contruction_worker:',
        ':man:'
    ],
    '👷{{skin_tone}}‍♀️': [
        'Kvinde Konstruktionsarbejder',
    ...
    '💁{{skin_tone}}': [
        'Person Drikkepenge Hånd',
        ':person_tipping_hand:',
        'Information Skrivebordsperson',
        ':tipping_hand:',
        ':person:'
    ],
    '🙆{{skin_tone}}‍♂️': [
    ...
    '👨{{skin_tone}}‍🦯': [
        'Mand med Hvid sukkerrør',
        ':man_with_white_cane:',
        ':white_cane:',
        ':man:'
    ],
    '👩{{skin_tone}}‍🦯': [
        'Kvinde med hvid sukkerrør',
        ':woman_with_white_cane:',
        ':white_cane:',
        ':woman:'
    ],
    '🧑{{skin_tone}}‍🦯': [
        'Person med hvid sukkerrør',
        ':person_with_white_cane:',
        ':white_cane:',
        ':person:'
    ],
    '👨{{skin_tone}}‍🦼': [
        'Mand i motoriseret kørestol',
        ':man_in_motorized_wheelchair:',
        ':motorized_wheelchair:',
        ':man:'
    ],
    '👩{{skin_tone}}‍🦼': [
        'Kvinde i motoriseret kørestol',
        ':woman_in_motorized_wheelchair:',
        ':motorized_wheelchair:',
        ':woman:'
    ],
    '🧑{{skin_tone}}‍🦼': [
        'Person i motoriseret kørestol',
    ...
    '🧑‍🤝‍🧑': [
        ...
        'To Personer Holding Hænder',
        'Kønsinklusivt Par',
        'Køn Neutralt Par',
        'Køn Ikke-overensstemmende Par',
        ':person:'
    ],
    '👨‍👩‍👦': [
    ...
    '💏{{skin_tone}}': [
        ...
        ':couple_kissing:',
        'Kys',
        'Køn Neutral Couple Kissing',
        ':person:'
    ],
    '👩‍❤️‍💋‍👨': [
        'Mand og kvinde kysse',
    ...
    '👩‍❤️‍💋‍👩': [
        'To Kvinder Kysser',
        ':two_women_kissing:',
        'Kvinde og kvinde kysse',
        ':woman:'
    ],
    '💆{{skin_tone}}‍♂️': [
        'Mand Henter Hovedmassage',
        ':man_getting_head_massage:',
        ':getting_head_massage:',
        ':man:'
    ],
    '💆{{skin_tone}}‍♀️': [
        'Kvinde Getting Head Massage',
    ...
    '💇{{skin_tone}}‍♀️': [
        'Kvinde Getting Haircut',
        ':woman_getting_haircut:',
        ':getting_haircut:',
        ':woman:'
    ],
    '💇{{skin_tone}}': [
        'Person Henter Haircut',
...
emojis_language[lang][5] = {
    ...
    '◼️': [
        'Sort Mellemstor Firkant',
        ':black_medium_square:',
        ':black:'
    ],
    '◻️': [
        'Hvid Mellemstor Firkant',
        ':white_medium_square:',
        ':white:'
    ],
    '◾': [
...
emojis_language[lang][8] = {
    ...
    '🤽{{skin_tone}}‍♂️': [
        'Mand, Der Spiller Vand Polo',
        ':man_playing_water_polo:',
        ':playing_water_polo:',
        ':man:'
    ],
    '🤽{{skin_tone}}‍♀️': [
        'Kvinde Spille Vand Polo',
        ':woman_playing_water_polo:',
        ':playing_water_polo:',
        ':woman:'
    ],
    '🤽{{skin_tone}}': [
        'Person, Der Spiller Vand Polo',
        ':person_playing_water_polo:',
        ':playing_water_polo:',
        ':person:'
    ],
    '🤾{{skin_tone}}‍♂️': [
        'Mand Afspiller Håndbold',
        ':man_playing_handball:',
        ':playing_handball:',
        ':man:'
    ],
    '🤾{{skin_tone}}‍♀️': [
        'Kvinde Spiller Håndbold',
        ':woman_playing_handball:',
        ':playing_handball:',
        ':woman:'
    ],
    '🤾{{skin_tone}}': [
        'Person, Der Spiller Håndbold',
...
emojis_language[lang][12] = {
    ...
    '🫰{{skin_tone}}': [
        'Hånd med indeks Finger og tommelfinger krydsede',
        ':hand_with_index_finger_and_thumb_crossed:'
    ],
    '🫵{{skin_tone}}': [
        'Indeks peger på fremviseren',
