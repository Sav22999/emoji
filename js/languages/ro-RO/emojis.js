...
titles_language[lang] = {
    ...
    '🏳️‍🌈': 'Semnalări',
    '🏊': 'Sport',
    '✈️': 'Călătorie și locuri',
    '🖱️': 'Tehnologii şi birouri',
    '👗': 'Îmbrăcăminte și accesorii',
    '🖐️': 'Mâini şi părţi ale corpului',
    '🛎️': 'Altele'
};
...
emojis_language[lang][2] = {
    ...
    '😄': [
        ...
        'Față zâmbitoare cu ochi de gură și zâmbet deschise'
    ],
    '😁': [
    ...
    '😆': [
        ...
        'Zâmbet închis',
        'Râs',
        'Clasificare față cu ochi închiși în strâmtorat',
        'Față zâmbitoare cu gură deschisă și ochi închiși'
    ],
    '😅': [
        ...
        'Faţă zâmbitoare cu gură deschisă şi sudoat rece'
    ],
    '🤣': [
        'ROFL',
        'Râzând pe podea'
    ...
    '😜': [
        ...
        'Faţă cu tonaj blocat şi ochi Winking'
    ],
    '🤪': [
        'Zany Face',
        'Ochi nebuni',
        ...
        'Sălbatic',
        'Goofy Face',
        'Clasificare față mare și un ochi mic'
    ],
    '😝': [
    ...
    '🤗': [
        ...
        'Umflare',
        'Îmbrăcăminte',
        'Față fericită cu Mâinile de Călătorit'
    ],
    '🤭': [
        'Up-uri',
        'Faţă cu gură',
    ...
    '🤫': [
        ...
        'Silențios',
        'Silențios',
        'Față cu buzele închise care acoperă degetul'
    ],
    '🤔': [
        'Ce',
        '?',
    ...
    '🤨': [
        ...
        'Față cu un singur bromură de ochi ridicată'
    ],
    '😐': [
        'Față neutră',
        ':|',
    ...
    '😬': [
        ...
        'Picior pe munte',
        'Nervos',
        'Snapchat Mutual #1 Cel mai bun prieten'
    ],
    '🤥': [
        'Față latură',
        'Litir',
    ...
    '😮': [
        ...
        'Deschide gura',
        'Față surprinsă cu gură deschisă'
    ],
    '😯': [
        'Față drăguță',
        ':O',
    ...
    '😰': [
        ...
        'Față îngrijorată',
        'Față Nervoasă',
        'Faţă cu gură deschisă şi sudoraţie rece'
    ],
    '😥': [
...
emojis_language[lang][3] = {
    ...
    '👰‍{{skin_tone}}‍♂️': ['Man cu Veil'],
    '👰‍{{skin_tone}}‍♀️': ['Femeie cu Veil'],
    ...
    '🤷‍{{skin_tone}}‍♂️': ['Omul de bălegar'],
    '🤷‍{{skin_tone}}‍♀️': ['Cârlige de Femei'],
...
emojis_language[lang][4] = {
    '😺': [
        ...
        'Zâmbește fața pisicii cu gură deschisă'
    ],
    '😸': [
...
emojis_language[lang][8] = {
    ...
    '🧘‍‍{{skin_tone}}‍♂️': ['Om în poziția de Lotus'],
    '🧘‍‍{{skin_tone}}‍♀️': ['Femeie în poziția de Lotus'],
